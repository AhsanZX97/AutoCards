...
export const nav: Dict<typeof en> = {
  ...
  'nav.marketing.footerGuides': 'Guías',
  'nav.marketing.footerCompare': 'Comparativas',
  'nav.marketing.pdfGuide': 'De PDF a tarjetas',
  'nav.marketing.pptGuide': 'De PowerPoint a tarjetas',
  'nav.marketing.wordGuide': 'De Word a tarjetas',
  'nav.marketing.notesGuide': 'De apuntes de clase a tarjetas',
  'nav.marketing.vsAnki': 'Auto Cards frente a Anki',
  'nav.marketing.vsQuizlet': 'Auto Cards frente a Quizlet',
